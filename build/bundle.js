...
/***/ function(module, exports, __webpack_require__) {
	...
	var _AudioPlayer = __webpack_require__(159);
	  ...
	  _createClass(App, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        'div',
	        { id: 'App' },
	        _react2.default.createElement(_AudioPlayer2.default, { songs: songs })
	      );
	    }
	  }]);
	...
	var AudioPlayer = function (_Component) {
	  ...
	  _createClass(AudioPlayer, [{
	    ...
	    value: function getDuration() {
	      var duration = Math.floor(this.audio.duration);

	      var minutes = Math.floor(duration / 60);
	      var seconds = duration % 60;

	      seconds = seconds >= 10 ? seconds : '0' + seconds;
	      var totalTimeDisplay = minutes + ":" + seconds;
	    ...
	    value: function updateTime() {
	      ...
	      seconds = seconds >= 10 ? seconds : '0' + seconds;
	      var currentTimeDisplay = minutes + ":" + seconds;
	    ...
	    value: function toggleMute() {
	      var currentVolume = this.audio.volume;
	      var volume = currentVolume === 0 ? this.state.preVolumeValue : 0;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var VolumeBar = function (_Component) {
	  ...
	  function VolumeBar() {
	    ...
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(VolumeBar).apply(this, arguments));
	  }
